...
class WorkingHours extends Model {
  ...
  private function getTimes() {
    ...
    $this->time1 ? array_push($times, $this->time1) : array_push($times, null);
    $this->time2 ? array_push($times, $this->time2) : array_push($times, null);
    $this->time3 ? array_push($times, $this->time3) : array_push($times, null);
    $this->time4 ? array_push($times, $this->time4) : array_push($times, null);
